...
def load(name: str, device: Union[str, torch.device] = "cuda" if torch.cuda.is_available() else "cpu", jit: bool = False, download_root: str = None):
    ...
    download_root: str
        path to download the model files; by default, it uses "./pretrained_model"
    ...
    """
    if name in _MODELS:
        model_path = _download(_MODELS[name], download_root or os.path.expanduser("./pretrained_model"))
